...
public class Drogueria {
    ...
    /**
     * Este metodo registra un pedido verificando que el producto seleccionado tenga disponibilidad en stock con ayuda del assert
     * @param pedido
     */
    ...
    /**
     * Este metodo retorna los productos con cantidad mayor a 100 en stock 
     * @return
     */
    ...
    public double costoTotalPedido(Cliente cliente) {
        ...
        for (Pedido pedido : ListaPedidos) {
            if (pedido.getClientePedido().equals(cliente)) {
                costo = pedido.getCantidad() * pedido.getProductoPedido().getPrecio();
            }
        }
        return costo;
    }
